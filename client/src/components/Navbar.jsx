...
import { Container, Nav, Navbar as BootstrapNavbar, Button } from 'react-bootstrap'; // Button ইমপোর্ট করা হয়েছে
      ...
      <Container>
        ...
        <BootstrapNavbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto align-items-center">
            ...
            {user ? (
              <>
                <Nav.Link as={NavLink} to="/dashboard" className="mx-2 fw-medium">Appointments</Nav.Link>
